      ...
      <div className='container-fluid'>
        ...
        <div className='row mt-lg-3'>
          ...
          <div className='col-md-8 text-center'>
            <h1 className='mt-5 py-2 ' style={{ fontFamily: 'Lato' }}><b>Jannat Scholarship</b></h1>
            <p className='py-3 fs-4'>The Jannat Hostel will award scholarship to DEO current residents for a total of Rs.1,00,000/- (One Lakh ) in awards.</p>
            <img className='w-100' src='images/scholarships.jpg' style={{ height: '400px' }}></img>
          </div><div className='col-md-2'>
          </div>
          <div className='custom-orange-bg mt-5'>
            <div className='bg-warning mt-5 mx-1 '>
              ...
              <div className='card mt-5 border-0 px-lg-5 px-3 w-100'>
                <div className='card-body px-lg-5 d-flex flex-column ' style={{ minHeight: '200px' }}>
                  <p className='card-title fs-3 fw-100 py-lg-3'>Judging Criteria</p>
