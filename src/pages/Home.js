  ...
  return (
    <>
      <div className=' container-fluid' >
        <Navbar/>
        <Carousel />
        <div className='ms-1 me-1' style={{ overflow: 'hidden' }}>
          <Accomodation />
          {/* live with dignity */}
          <div className='row mt-5  position-relative' style={{ backgroundImage: "radial-gradient(circle farthest-corner at 46% 87.5%, rgba(177, 232, 248, 1) 13.3%, rgba(49, 75, 125, 1) 89.7%)" }}>
            ...
            <div className='position-relative' style={{ display: 'flex', justifyContent: 'center' }}>
              <img className='small-screen-image w-100 m-2' src='https://lv2.be1.myftpupload.com/wp-content/uploads/2021/03/1.jpg' alt='' />
            </div>
            <div className='card position-relative bg-warning ms-lg-5' style={{ height: '400px', width: '400px' }}>
              ...
              <div className='position-absolute' style={{ marginLeft: '350px', top: '75px' }}>
                <img className='large-screen-image size' src='https://lv2.be1.myftpupload.com/wp-content/uploads/2021/03/1.jpg' alt=''/>
              </div>
            </div>
          </div>
          ...
          <div className='row mt-5 position-relative lg-screen'>
            <img src='https://c8.alamy.com/comp/2GNCB8T/modern-youth-hostel-building-accommodation-for-students-and-young-people-building-exterior-2GNCB8T.jpg'
              style={{ opacity: '0.3', height: '850px' }} alt='....'/>
            ...
            <img src='aboutus.jpg' className='position-absolute' style={{ height: '700px', width: '450px', marginLeft: '170px', bottom: '0', marginBottom: '44px' }} alt='...'/>
          </div>
          ...
          <div className='row mt-5 position-relative md-screen'>
            ...
            <img src='aboutus.jpg' alt='..' className='position-absolute col-md-3' style={{ height: '700px', width: '280px', marginLeft: '40px', bottom: '0', marginBottom: '44px' }} />
          </div>
          {/* end of about us */}

          {/* cards */}
          <div className='card-group  row text-center mt-5 d-flex flex-wrap justify-content-evenly'>
          ...
          {/* join our home */}
          <div className=' row mt-5 my-2 bg-info text-center'>
            <div>
          ...
          <div className='row pe-lg-4 mt-5 bg-dark text-center custom-dark-bg'>
            <h1 className='mt-5 text-light ms-lg-3 me-lg-3 p-3'>Our aim is to provide high quality services at Deo Hostel under affordable rent to our residents and We Care
            </h1>
            <div className='card-group mt-5 ms-3 me-3 d-flex justify-content-evenly flex-wrap'>
              <div className='card'>
                <div className='card-body'>
            ...
            <div className='mb-5 '>
              ...
              {activeCard === 0 | activeCard === null &&
                <div className=' ms-lg-3 card w-100' >
                  <div className='row w-100'>
                    ...
                    <div className='col-md-5'>
                      <div className='m-auto p-2 w-100 '>
                        <img className=' justify-content-center' src='https://cdn.dnaindia.com/sites/default/files/styles/full/public/2017/12/18/634046-sports-ground.jpg' alt='' height={'400px'} width={'450px'} />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='row '>
                    ...
                    <div className='col-md-5'>
                      <div className=' m-auto p-2'>
                        <img className='w-100' src='images/scholarships.jpg' alt='..' height={'400px'} />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeCard === 2 &&
                <div className='mx-1'>
                  <div className=' ms-lg-3 card w-100 mx-lg-3 ' style={{marginLeft:''}} >
                  <div className='row '>
                    <div className='col-md-7 '>
                      <div className='card-body '>
                    ...
                    <div className='col-md-5 '>
                      <div className=' m-auto p-2'>
                        <img className='w-100 justify-content-center' src='https://i.ytimg.com/vi/jVouw7urAKo/maxresdefault.jpg' alt='...' height={'300px'} />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {/* connect */}
          <div className='row custom-orange-bg pt-lg-5 pt-sm-3 pb-lg-5 pg-sm-3 '>
            <div className=' mb-5 bg-warning p-2 shadow-lg ' style={{ marginTop: '50px' }}>
              <h1 className='text-center '>Connect</h1>
              <p className='text-center fs-5 p-3'>We are happy to answer any questions. Call us, fill out the contact form or use WhatsApp!</p>
              <div className='card mx-2 p-1'> 
                <div className='row '>
                  <div className='col-md-5'>
                    <div className='card-body'>
                      <img className='w-100' src='images/location.jpeg' alt='..' height='300px' />
                    </div>
                  </div>
                  <div className='col-md-7'>
                    <div className='card-body'>
