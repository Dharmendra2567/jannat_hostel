                    ...
                    <div className='card shadow-lg px-lg-5'>
                        <div className='card-body w-100'>
                            ...
                            <div className='input-group w-100'>
                                ...
                                <div className='form-floating shadow-lg'>
                                    <input type='password' className='form-control w-100' id='password' placeholder='Enter your password' onChange={e => setPassword(e.target.value)}></input>
                            ...
                            <div className='text-center'>
                                <button className='btn btn-success my-5 w-50 ' type='submit' onClick={handleSubmit}>Login</button>
                            </div>
                            <div>
